<?php
/**
 * Plugin Name: Custom Rank Math REST Fields
 * Plugin URI: https://www.iweaver.ai/
 * Description: Exposes Rank Math SEO meta fields for pages in the WordPress REST API so external publishing tools can write TDK values.
 * Version: 1.0.0
 * Author: iWeaver
